...
const rawMockApi = {
    activate_template_set: async (id) => ({ status: "success", active_set_id: id }),
    ...
    browse_template_set_files: async (role) => window.__mockResponses.browse_template_set_files || { status: "cancelled" },
    ...
    create_template_set: async (name, desc, fallback) => ({ status: "success", set_id: "mock_set" }),
    delete_custom_template: async (id, e) => ({ status: "success" }),
    delete_template_set: async (id) => ({ status: "success" }),
    detect_classes: async (cfg) => window.__mockResponses.detect_classes,
    duplicate_template_set: async (id, name) => ({ status: "success", set_id: "mock_dup" }),
    export_parser_config: async () => ({ status: "success" }),
    export_template_set: async (id, path) => ({ status: "success", export_path: path }),
    get_active_template_set: async () => window.__mockResponses.get_active_template_set || { set_id: "builtin_cvsu" },
    ...
    get_template_sets: async () => window.__mockResponses.get_template_sets || [],
    ...
    import_template_set: async (path) => ({ status: "success", set_id: "imported_set" }),
    ...
    inspect_template_set_files: async (paths) => window.__mockResponses.inspect_template_set_files || { results: [] },
    ...
    save_template_set: async (id, data) => ({ status: "success" }),
    set_template_set_fallback: async (id, fallback) => ({ status: "success" }),
    toggle_custom_template: async (id, e) => ({ status: "success" }),
    update_template_set: async (id, data) => ({ status: "success" }),
